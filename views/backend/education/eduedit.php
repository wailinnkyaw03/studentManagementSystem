    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            ...
            <?php }?>
                ...
                <h1 class="h3 my-5 text-gray-800"><i class="fas fa-home-user me-2"></i>Edit Education Background</h1>
                        ...
                        <div class="row">
                            <div class="col-sm-3 my-1">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="university" name="university" value="<?php echo $education['university'] ?>">
                            ...
                            <div class="col-sm-3 my-1">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="subject" name="subject" value="<?php echo $education['subject'] ?>">
                            ...
                            <div class="col-sm-3 col-6 my-1">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="started_date" name="started_date" value="<?php echo $education['started_date'] ?>">
                            ...
                            <div class="col-sm-3 col-6 my-1">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="ended_date" name="ended_date" value="<?php echo $education['ended_date'] ?>">
