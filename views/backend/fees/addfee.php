    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            ...
            <?php }?>
                ...
                <h1 class="h3 my-5 text-gray-800"><i class="fas fa-dollar me-2"></i> Add Fee </h1>

                <form action="../../controllers/FeeController.php" method="post">
                    <div class="form-floating my-3">
                        <input type="number" class="form-control" id="feeamount" name="feeamount" placeholder="feeamount">
                    ...
                    <div class="form-group text-end">
                        <button class="btn btn-outline-secondary my-3 me-2" type="submit"><i class="fas fa-dollar me-2"></i>Add Fee</button>
