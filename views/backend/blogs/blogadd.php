    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            ...
            <?php }?>
                ...
                <h1 class="h3 my-5 text-gray-800"><i class="fas fa-blog me-2"></i>Add Blog</h1>
                ...
                <form action="../../controllers/BlogController.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group text-end">
                        <button class="btn btn-outline-secondary my-3 me-2" type="submit"><i class="fas fa-plus-circle me-2"></i>Add Blog</button>
