            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="admin.php?page=addAdmin"><i class="fas fa-user-plus me-2"></i> Add Admin</a>
                        <a class="collapse-item" href="admin.php?page=adminlist"><i class="fas fa-list me-2"></i> Admin List</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="student" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="admin.php?page=addStudent"><i class="fas fa-user-plus me-2"></i> Add Student</a>
                        <a class="collapse-item" href="admin.php?page=studentlist"><i class="fas fa-list me-2"></i> Student List</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="tutor" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tutor Components:</h6>
                        <a class="collapse-item" href="admin.php?page=addTutor"><i class="fas fa-user-plus me-2"></i> Add Tutor</a>
                        <a class="collapse-item" href="admin.php?page=tutorlist"><i class="fas fa-list me-2"></i> Tutor List</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="classtypes" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Class Components:</h6>
                        <a class="collapse-item" href="admin.php?page=addClass"><i class="fas fa-plus me-2"></i> Add Class Category</a>
                        <a class="collapse-item" href="admin.php?page=classlist"><i class="fas fa-list me-2"></i> Class Categories</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="coursedetail" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Course Components:</h6>
                        <a class="collapse-item" href="admin.php?page=addCourse"><i class="fas fa-plus me-2"></i> Add Course</a>
                        <a class="collapse-item" href="admin.php?page=courselist"><i class="fas fa-list me-2"></i> Course List</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="../../assets/profileImages/<?php echo $_SESSION['userimage'] ?>">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="../../controllers/AdminLoginController.php?action=logout">
